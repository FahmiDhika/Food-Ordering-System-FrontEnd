...
const sideBar = ({ children, id, title, menuList }: cashierProp) => {
  ...
  return (
    <div className="w-full min-h-dvh">
      <header className="h-auto flex justify-between items-center p-4 mb-o headerBackground shadow-xl">
        <div className="flex gap-2 items-center">
          ...
          <h1 className="font-bold text-2xl text-orange-400 tracking-wider">
            {title}
          </h1>
        </div>
